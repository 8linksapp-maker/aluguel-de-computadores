...
import tech from '../data/themes/tech.json';
...
export const PRESETS: Record<string, ThemePreset> = { dental, harmonizacao, tech };
...
export function resolveTheme(): { vars: Record<string, string>; preset: ThemePreset } {
  const preset = PRESETS[themeConfig.preset] ?? PRESETS.tech;
